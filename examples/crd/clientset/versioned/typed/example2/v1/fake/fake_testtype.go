...
import (
	...
	example2v1 "github.com/Kotodian/code-generator/examples/crd/apis/example2/v1"
...
func (c *FakeTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *example2v1.TestTypeList, err error) {
	obj, err := c.Fake.
