...
import (
	...
	example "github.com/Kotodian/code-generator/examples/apiserver/apis/example"
	...
	internalversion "github.com/Kotodian/code-generator/examples/apiserver/listers/example/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Example().TestTypes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Example().TestTypes(namespace).Watch(context.TODO(), options)
			},
		},
		&example.TestType{},
		resyncPeriod,
